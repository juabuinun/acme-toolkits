...
<acme:form>
	...
	<acme:input-textbox code="admin.announcement.link" path="link" placeholder="default.placeholder.url"/>

	<jstl:if test="${command == 'create'}">
		<acme:submit code="admin.announcement.create" action="/administrator/announcement/create" />
	</jstl:if>
</acme:form>
