...
public abstract class AbstractPatronageReportUnbindService<R extends UserRole> extends AbstractCrudServiceImpl<PatronageReport,PatronageReportRepository> implements UnbindMethod<R,PatronageReport>{

	protected AbstractPatronageReportUnbindService(final PatronageReportRepository repo, final ModelMapper mapper) {
		super(repo, mapper);
	}
