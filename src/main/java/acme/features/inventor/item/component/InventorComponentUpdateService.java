...
@Service
@Transactional
public class InventorComponentUpdateService extends AbstractInventorItemUpdateService{

	@Autowired
	protected InventorComponentUpdateService(final ItemService service, final AcmeConfigurationService configService, final InventorRepository inventorRepo) {
