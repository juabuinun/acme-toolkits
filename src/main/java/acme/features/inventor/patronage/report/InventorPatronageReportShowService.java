...
@Service
public class InventorPatronageReportShowService extends AbstractAuthoriseAll<Inventor,PatronageReport> implements AbstractShowService<Inventor,PatronageReport>{
