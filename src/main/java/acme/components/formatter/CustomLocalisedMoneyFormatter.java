...
public class CustomLocalisedMoneyFormatter implements Formatter<CustomMoney> {

	// Formatter<Money> interface ---------------------------------------------

	@Override
	public String print(final CustomMoney object, final Locale locale) {
		assert object != null;
		assert locale != null;
	...
	@Override
	public CustomMoney parse(final String text, final Locale locale) throws ParseException {
		assert text != null;
		assert locale != null;
