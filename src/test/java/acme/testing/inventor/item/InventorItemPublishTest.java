...
public class InventorItemPublishTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/publish-positive-item.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(101)
	public void positiveInventorItemPublish(final int index, final String itemType, final String name, final String technology, final String description, final String price, final String info) {
...
//		super.checkColumnHasValue(0, 0, code);
		...
		super.checkColumnHasValue(index, 4, "true");

		super.signOut();
	}
	
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/publish-negative-item.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(80)
	public void negativeInventorItemPublish(final int index, final String itemType, final String name, final String technology, final String description, final String price, final String info) {
		super.signIn("inventor1", "inventor1");
